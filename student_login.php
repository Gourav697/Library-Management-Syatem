  ...
  <body>
    <section>
      <div class="log_img">
        ...
        <div class="box1">
          <h1
            style="text-align: center; font-size: 35px; font-family: Lucida Console; ">
          ...
          <form name="login" action="" method="post">
            ...
            <p style="color: white; padding-left: 15px">
              ...
              &nbsp &nbsp &nbsp &nbsp &nbsp New to this website?<a
                style="color: white"
    ...
    if(isset($_POST['submit']))
    {
      ...
      if($count==0)
      {
       ...
       <script text="text/javascript">
        ...
        --->
        <div class="alert alert-warning" style="width: 700px; margin-left: 700px;
